  ...
  <div class="content-wrapper v-container tab-content" >
    <div id="student-rcd" class="">
      <div class="top mrgn_40_btm">
        <div class="container">
          <div class="row">
            <a href="{{ url('admin/vchipPlacement')}}" class="btn btn-primary">Vchip Placement</a>&nbsp;
            <a href="{{ url('admin/collegePlacement')}}" class="btn btn-default" >College Placement</a>
          </div>
          <br>
          <div class="row">
...
<script type="text/javascript">
  ...
  function searchStudent(){
    ...
    if(college && selected_dept && selected_year && student.length > 0){
      $.ajax({
          method: "POST",
          url: "{{url('admin/searchVchipStudentByCollegeByDeptByYearByName')}}",
  ...
  function showStudents(){
    ...
    $.ajax({
      method: "POST",
      url: "{{url('admin/showVchipPlacementVideoByCollegeIdByDeptIdByYear')}}",
