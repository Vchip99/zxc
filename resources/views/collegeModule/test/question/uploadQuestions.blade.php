...
@section('dashboard_content')
	...
	<div  class="admin_div">
		<div class="form-group row">
		    ...
		    <div class="col-sm-3"><a class="btn btn-primary btn-big" href="{{asset('Download Excel Questions File.xlsx')}}" download data-toggle="tooltip" data-placement="bottom">Download Excel Questions File</a>
		    </div>
		    <div class="col-sm-3">
		    ...
		    <div class="modal fade" id="modelUploadImages" >
	          	<div class="modal-dialog" role="document" >
		            <div class="modal-content" >
		              	...
		              	<form id="uploadImagesForm" action="{{url('college/'.Session::get('college_user_url').'/uploadCollegeTestImages')}}" method="POST" enctype="multipart/form-data">
						{{csrf_field()}}
		...
		<form id="questionForm" action="{{url('college/'.Session::get('college_user_url').'/uploadCollegeQuestions')}}" method="POST" enctype="multipart/form-data">
			{{csrf_field()}}
