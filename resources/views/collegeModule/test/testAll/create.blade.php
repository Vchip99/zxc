...
@section('dashboard_content')
  ...
  <!-- <div class="container admin_div">
   <form action="{{url('college/'.Session::get('college_user_url').'/createAllTestCategory')}}" method="POST" id="submitCategoryForm">
    {{ csrf_field() }}
  ...
  <br> -->
  <div class="container admin_div">
    <form action="{{url('college/'.Session::get('college_user_url').'/createAllTestSubCategory')}}" method="POST" enctype="multipart/form-data" id="submitSubCategoryForm">
      {{ csrf_field() }}
      <div class="form-group row @if ($errors->has('category')) has-error @endif">
  ...
  <br>
  <div class="container admin_div">
    <form action="{{url('college/'.Session::get('college_user_url').'/createAllTestSubject')}}" method="POST" id="submitSubjectForm">
      {{ csrf_field() }}
      <div class="form-group row @if ($errors->has('category')) has-error @endif">
        <label class="col-sm-2 col-form-label">Category Name:</label>
        <div class="col-sm-3">
  ...
  <br>
  <div class="container admin_div">
    <form action="{{url('college/'.Session::get('college_user_url').'/createAllTestPaper')}}" method="POST" id="submitPaperForm">
      {{ csrf_field() }}
      <div class="form-group row @if ($errors->has('category')) has-error @endif">
        <label class="col-sm-2 col-form-label">Category Name:</label>
        <div class="col-sm-3">
...
<script type="text/javascript">
  ...
  function searchSubCategory(){
    ...
    if(category && subcategory){
      $.ajax({
        method:'POST',
        url: "{{url('isTestSubCategoryExist')}}",
  ...
  function selectPaperSubject(ele){
    ...
    if( 0 < catId && 0 < subcatId ){
      $.ajax({
          method: "POST",
          url: "{{url('getCollegeSubjectsByCatIdBySubcatId')}}",
