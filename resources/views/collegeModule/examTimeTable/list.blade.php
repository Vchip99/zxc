...
@section('dashboard_content')
  <div class="container">
    ...
    <div class="form-group row">
      <div>
        <a href="{{url('college/'.Session::get('college_user_url').'/createExamTimeTable')}}" type="button" class="btn btn-primary" style="float: right;" title="Add Exam Time Table">Add Exam Time Table</a>&nbsp;&nbsp;
      </div>
    </div>
    <div>
          ...
          @if(count($timeTables) > 0)
            ...
            <tr style="overflow: auto;">
              ...
              <td>
                ...
                <a href="{{url('college/'.Session::get('college_user_url').'/examTimeTable')}}/{{$timeTable->id}}/edit" ><img src="{{asset('images/edit1.png')}}" width='30' height='30' title="Edit {{$timeTable->name}}" />
                  </a>
                @endif
              </td>
              <td>
                @if(4 ==  Auth::User()->user_type || 5 ==  Auth::User()->user_type || 6 ==  Auth::User()->user_type)
                  ...
                  <form id="deleteTt_{{$timeTable->id}}" action="{{url('college/'.Session::get('college_user_url').'/deleteExamTimeTable')}}" method="POST" style="display: none;">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
