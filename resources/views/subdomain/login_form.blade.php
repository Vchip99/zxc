                    ...
                    <div class="tab-content">
                      ...
                      <div id="menu1" class="tab-pane fade">
                        <form id="registerUser" method="post" action="{{ url('register')}}">
                          ...
                          <button name="register" class="btn btn-info btn-block" onclick="event.preventDefault(); confirmSubmit();">Register</button></br>
                        </form>
                        <div>
                          <a data-toggle="tab" href="#home">alredy member?</a>
                        </div>
                      </div>
                    </div>
                  </div>
