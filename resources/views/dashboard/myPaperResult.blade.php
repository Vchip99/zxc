...
@section('dashboard_content')
  <section  class="v_container v_bg_grey">
    <div class="container">
      <h2 class="v_h2_title text-center"> Result</h2>
            ...
            <div class="col-md-8">
              <div class="inline-block">
                  <div class="inline-block ">
                    ...
                    </span> {{$score->right_answered}}
                  </div>
                  <div class="inline-block">
                    <span class="ans ans-wrong" title="Incorrect">
                        <i class="fa fa-close"></i>
                    </span> {{$score->wrong_answered}}
                  </div>
                  <div class="inline-block">
                   ...
                   <div class="inline-block">
                      ...
                      <span class="ans ans-score hidden-md hidden-lg">
                       ...
                       {{$score->test_score}}/{{$totalMarks}}
                  </div>
                  <div class="inline-block">
                       <span class="hidden-sm hidden-xs"><b> College Rank:</b></span>
                      <span class="ans ans-rank hidden-md hidden-lg">
                          <i class="fa fa-tachometer"></i>
                      </span>
                       {{ $collegeRank + 1}}/{{$collegeTotalRank}}
                  </div>
                  <div class="inline-block">
                       <span class="hidden-sm hidden-xs"><b> Global Rank:</b></span>
                      <span class="ans ans-rank hidden-md hidden-lg">
                          <i class="fa fa-globe"></i>
                      </span>
                       {{ $globalRank + 1}}/{{$globalTotalRank}}
                  </div>
                 </div>
              </div>
            <div class="col-md-4 sol-btn" >
                @if(1 == $score->paper->show_solution)
              <form class="form-horizontal" role="form" id='solution' method="post" action="{{url('college/'.Session::get('college_user_url').'/showUserTestSolution')}}">
            {{ csrf_field() }}
                ...
                <div class="col-md-4 prg-bar">
                  ...
                  <ul class="list-unstyled progress-list">
                    ...
                    <li class="">
                      ...
                      <span class="pull-right text-ellipsis value ng-binding">{{$score->unanswered}}</span>
                    </li>
                  </ul>
                </div>
              <div class="col-md-4 prg-bar">
