  ...
  <div class="content-wrapper v-container tab-content" >
    <div id="student-rcd" class="">
      <div class="top mrgn_40_btm">
        <div class="container">
          <div class="row">
            <a href="{{ url('college/'.Session::get('college_user_url').'/collegeTestResults')}}" class="btn btn-primary">College All Test Result</a> &nbsp;<a href="{{ url('college/'.Session::get('college_user_url').'/vchipTestResults')}}" class="btn btn-default">Vchip All Test Result</a>
          </div>
          <br>
          <div class="row">
