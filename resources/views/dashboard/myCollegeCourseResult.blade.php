...
@section('dashboard_content')
    ...
    <div class="">
      <div class="container">
        <div class="row">
          <a href="{{ url('college/'.Session::get('college_user_url').'/myCollegeCourseResults')}}" class="btn btn-primary">College Courses Results</a> &nbsp;<a href="{{ url('college/'.Session::get('college_user_url').'/myVchipCourseResults')}}" class="btn btn-default">Vchip Courses Results</a>
        </div>
        <br>
        <div class="row">
