...
@section('dashboard_content')
    ...
    <div class="">
      <div class="top mrgn_20_btm">
        <div class="container">
          <div class="row">
            <a href="{{ url('college/'.Session::get('college_user_url').'/studentCollegeCourses')}}" class="btn btn-primary">College Courses</a> &nbsp;<a href="{{ url('college/'.Session::get('college_user_url').'/studentVchipCourses')}}" class="btn btn-default">Vchip Courses</a>
...
<script type="text/javascript">
  ...
  function renderResult(category,subcategory,student,year,department){
     $.ajax({
          method: "POST",
          url: "{{url('showCollegeStudentCourses')}}",
