...
@section('dashboard_content')
    ...
    <div class="">
      <div class="top mrgn_20_btm">
        <div class="container">
          <div class="row">
            <a href="{{ url('college/'.Session::get('college_user_url').'/studentCollegeTestResults')}}" class="btn btn-primary">College Test Result</a> &nbsp;<a href="{{ url('college/'.Session::get('college_user_url').'/studentVchipTestResults')}}" class="btn btn-default">Vchip Test Result</a>
...
<script type="text/javascript">
  ...
  function renderResult(category,subcategory,student,year,department){
    $.ajax({
              method: "POST",
              url: "{{url('showCollegeTestResults')}}",
