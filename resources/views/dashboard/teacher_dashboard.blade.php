    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('manageCategory')}}"><i class="fa fa-circle-o"></i> Manage Category </a></li>
            <li><a href="{{ url('manageSubCategory')}}"><i class="fa fa-circle-o"></i> Manage Sub Category </a></li>
