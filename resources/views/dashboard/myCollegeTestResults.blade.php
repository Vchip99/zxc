...
@section('dashboard_content')
    ...
    <div class="">
      <div class="container">
        <div class="row">
          <a href="{{ url('college/'.Session::get('college_user_url').'/myCollegeTestResults')}}" class="btn btn-primary" style="width: 140px;"> College Test Results</a>&nbsp;<a href="{{ url('college/'.Session::get('college_user_url').'/myVchipTestResults')}}" class="btn btn-default"> Vchip Test Results</a>
        </div>
        <br>
        <div class="row">
