                ...
                @if(1 == $message['is_group_message'])
                  @if(!empty($message['photo']))
                    <div class="form-group row">
                      <div class="col-md-3">
                        <img class="img-responsive" src="{{ url($message['photo']) }}" alt="message_img" style="max-height: 300px;width: 100%">
                      </div>
                      <div class="col-md-9">
                  ...
                  @endif
                @else
                  <div class="form-group row"><b>{{$message['date']}}-[Individual]</b> @ {{$message['message']}}
                  </div>
                @endif
              @endforeach
            @endif
