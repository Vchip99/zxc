...
@section('admin_content')
  ...
  <div class="container admin_div">
    <form action="{{url('admin/createAllCourseCategory')}}" method="POST" id="submitCategoryForm">
      {{ csrf_field() }}
  ...
  <br>
  <div class="container admin_div">
    <form action="{{url('admin/createAllCourseSubCategory')}}" method="POST" id="submitSubCategoryForm">
      {{ csrf_field() }}
      <div class="form-group row @if ($errors->has('category')) has-error @endif">
  ...
  <br>
  <div class="container admin_div">
    <form action="{{url('admin/createAllCourseCourse')}}" method="POST" enctype="multipart/form-data" id="submitCourseForm">
      {{ csrf_field() }}
      <div class="form-group row @if ($errors->has('category')) has-error @endif">
        <label class="col-sm-2 col-form-label">Category Name:</label>
        <div class="col-sm-3">
...
<script type="text/javascript">
  function searchCategory(){
    ...
    if(category){
      $.ajax({
        method:'POST',
        url: "{{url('admin/isCourseCategoryExist')}}",
