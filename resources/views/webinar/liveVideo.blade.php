	...
	<section id="vchip-background" class="mrgn_60_btm">
	  <div class="vchip-background-single">
	    <div class="vchip-background-img">
	      <figure>
	        <img src="{{ asset('images/error-page.jpg')}}" alt="Background" style="vertical-align:top; background-attachment:fixed" alt="vchip Live Video" />
	      </figure>
	    </div>
	  </div>
	</section>
	<section id="" class="v_container ">
		<div class="container text-center">
			<div class="mrgn_100_top_btm">
		        <h2 class="v_h2_title">Oops! Page Not Available</h2>
