...
@section('dashboard_content')
  <div class="container">
    ...
    <div class="form-group row">
      <div>
        <a href="{{url('createClientGalleryType')}}" type="button" class="btn btn-primary" style="float: right; width: 150px !important;" title="Add Gallery Type">Add Gallery Type</a>&nbsp;&nbsp;
      </div>
    </div>
    <div>
        ...
        <tbody id="">
          @if(count($galleryTypes) > 0)
            ...
            <tr style="overflow: auto;">
              ...
              <td>
                <a href="{{url('galleryType')}}/{{$galleryType->id}}/edit" ><img src="{{asset('images/edit1.png')}}" width='30' height='30' title="Edit {{$galleryType->name}}" />
                  </a>
              </td>
              <td>
              <a id="{{$galleryType->id}}" onclick="confirmDelete(this);"><img src="{{asset('images/delete2.png')}}" width='30' height='30' title="Delete {{$galleryType->name}}" />
                  ...
                  <form id="deleteGalleryType_{{$galleryType->id}}" action="{{url('deleteGalleryType')}}" method="POST" style="display: none;">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
