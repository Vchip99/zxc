	...
	<div class="content" oncontextmenu="return false;">
     	<div class="container">
			<div class="row">
				     		...
				     		<table class="table" >
			                    ...
			                    <tr >
								    <div class="row" >
										...
										<td>
										  <p >
											<button class="btn btn-sq-sm btn-danger load-ajax-modal" role="button" data-toggle="modal" data-target="#questions" title="Question paper">Que Paper </button >
											<a href="{{url('downloadQuestions')}}/{{$paper->category_id}}/{{$paper->sub_category_id}}/{{$paper->subject_id}}/{{$paper->id}}" class="btn btn-primary" id="myBtn" title="Download Question paper">Download</a>
										  </p>
									  	</td>
										</div>
									</div>
			    ...
			    <input type="hidden" id="Subject_id" name="Subject_id" value="{{$paper->subject_id}}">
