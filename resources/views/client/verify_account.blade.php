    ...
    <div class="container">
      <div class="row">
          <div class="v_contactus-area col-md-10">
			...
			@endif
            <div class="" >
                <form action="{{url('verifyClientEmail')}}" method="POST">
                {{ csrf_field() }}
                <div class="row text-center" >
                    <div class="col-md-8 col-md-offset-2" style="background: #eee; padding: 30px;">
                        ...
                        <button type="submit" class="btn btn-primary pull-right" id="btnContactUs" title="Send"> Send </button>
                        </div>
                    </div>
