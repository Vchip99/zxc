...
@section('content')
	...
	<div class="content" oncontextmenu="return false;" style="margin-top: 100px;">
     	<div class="container">
			<div class="row">
	    		<div class ="col-sm-9">
												...
												<div id='question{{$result->id}}' >
													<p class="questions" id="qname{{$result->id}}">
														@if(!empty($result->common_data))
															<span style="padding-left: 5px;">{!! preg_replace('/(<br \/>)+$/', '', $result->common_data); !!}</span></br>
														@endif
									    ...
									    <div class="row" >
											...
											<td>
											  <p >
												...
												<a href="{{url('downloadQuestions')}}/{{$paper->test_category_id}}/{{$paper->test_sub_category_id}}/{{$paper->test_subject_id}}/{{$paper->id}}" class="btn btn-primary" id="myBtn" title="Download Question paper">Download</a>
											  </p>
											  </td>
											</div>
										</div>
