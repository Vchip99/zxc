...
class ClientAssignmentAnswer extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['answer','teacher_comment','client_assignment_question_id', 'student_id', 'client_id', 'attached_link'];
    ...
    protected static function addAssignmentAnswer( Request $request){
        ...
        $assignmentAnswer->teacher_comment = $teacherComment?:'';
