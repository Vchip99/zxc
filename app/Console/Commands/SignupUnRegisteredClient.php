...
class SignupUnRegisteredClient extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'signupunregisteredclient:command';
     ...
     * @var string
     */
    protected $description = 'signup unregistered client on instamojo';
        ...
        try
        {
            ...
            if(is_object($clients) && false == $clients->isEmpty()){
                foreach($clients as $client){
                    $clientObj  = UserBasedAuthentication::where('vchip_client_id', $client->id)->first();
                    if(!is_object($clientObj)){
